...
#ifndef _NEW_MENU_DLL
  #ifdef _NEW_MENU_DLL_EXPORT
...
//NewMenu
#ifndef _NEW_MENU_DLL_EXPORT
    #ifndef _NEWMENU_DLL_LOADED
    #define _NEWMENU_DLL_LOADED
	#ifdef _WIN64 //_M_X64
		#ifdef _MFC_7
			#ifdef _DEBUG
				#ifdef _UNICODE
					#pragma message("     _Adding library: NewMenu7ud.lib: MFC7.0, Debug, UNICODE" ) 
					#pragma comment(lib, "../x64/Debug\\NewMenu7ud.lib")
				#else
					#pragma message("     _Adding library: NewMenu7d.lib: MFC7.0, Debug, MBCS" ) 
					#pragma comment(lib, "../x64/Debug\\NewMenu7d.lib")
				#endif
			#else
				#ifdef _UNICODE
					#pragma message("     _Adding library: NewMenu7u.lib: MFC7.0, Release, UNICODE" ) 
					#pragma comment(lib, "../x64/Release\\NewMenu7u.lib")
				#else
					#pragma message("     _Adding library: NewMenu7u.lib: MFC7.0, Release, UNICODE" ) 
					#pragma comment(lib, "../x64/Release\\NewMenu7.lib")
				#endif
			#endif
		#else
			#ifdef _DEBUG
				#ifdef _UNICODE
					#pragma message("     _Adding library: NewMenuud.lib: MFC4.2, Debug, UNICODE" ) 
					#pragma comment(lib, "../x64/Debug\\NewMenuud.lib")
				#else
					#pragma message("     _Adding library: NewMenud.lib: MFC4.2, Debug, MBCS" ) 
					#pragma comment(lib, "../x64/Debug\\NewMenud.lib")
				#endif
			#else
				#ifdef _UNICODE
					#pragma message("     _Adding library: NewMenuu.lib: MFC4.2, Release, UNICODE" ) 
					#pragma comment(lib, "../x64/Release\\NewMenuu.lib")
				#else
					#pragma message("     _Adding library: NewMenuu.lib: MFC4.2, Release, MBCS" ) 
					#pragma comment(lib, "../x64/Release\\NewMenu.lib")
				#endif
			#endif
		#endif
	#else
				...
				#ifdef _UNICODE
					#pragma message("     _Adding library: NewMenu7ud.lib: MFC7.0, Debug, UNICODE" ) 
					#pragma comment(lib, "../Win32/Debug\\NewMenu7ud.lib")
				#else
					#pragma message("     _Adding library: NewMenu7d.lib: MFC7.0, Debug, MBCS" ) 
					#pragma comment(lib, "../Win32/Debug\\NewMenu7d.lib")
				#endif
			#else
				#ifdef _UNICODE
					#pragma message("     _Adding library: NewMenu7u.lib: MFC7.0, Release, UNICODE" ) 
					#pragma comment(lib, "../Win32/Release\\NewMenu7u.lib")
				#else
					#pragma message("     _Adding library: NewMenu7u.lib: MFC7.0, Release, UNICODE" ) 
					#pragma comment(lib, "../Win32/Release\\NewMenu7.lib")
				#endif
			#endif
		#else
			#ifdef _DEBUG
				#ifdef _UNICODE
					#pragma message("     _Adding library: NewMenuud.lib: MFC4.2, Debug, UNICODE" ) 
					#pragma comment(lib, "../Win32/Debug\\NewMenuud.lib")
				#else
					#pragma message("     _Adding library: NewMenud.lib: MFC4.2, Debug, MBCS" ) 
					#pragma comment(lib, "../Win32/Debug\\NewMenud.lib")
				#endif
			#else
				#ifdef _UNICODE
					#pragma message("     _Adding library: NewMenuu.lib: MFC4.2, Release, UNICODE" ) 
					#pragma comment(lib, "../Win32/Release\\NewMenuu.lib")
				#else
					#pragma message("     _Adding library: NewMenuu.lib: MFC4.2, Release, MBCS" ) 
					#pragma comment(lib, "../Win32/Release\\NewMenu.lib")
				#endif
			#endif
		#endif
	#endif _WIN64
    #endif  _NEWMENU_DLL_LOADED
#endif  _NEW_MENU_DLL_EXPORT
