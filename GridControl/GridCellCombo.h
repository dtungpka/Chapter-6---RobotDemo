...
class GRID_CTRL_EXT_CLASS CGridCellCombo : public CGridCell
{
...
class GRID_CTRL_EXT_CLASS CComboEdit : public CEdit
{
// Construction
public:
	CComboEdit();
...
class GRID_CTRL_EXT_CLASS CInPlaceList : public CComboBox
{
