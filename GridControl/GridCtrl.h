...
#ifndef GRID_CTRL_EXT_CLASS
#define GRID_CTRL_EXT_CLASS GRIDCONTROL_EXT_CLASS
#endif GRID_CTRL_EXT_CLASS
...
typedef struct GRID_CTRL_EXT_CLASS tagNM_GRIDVIEW {
    NMHDR hdr;
    int   iRow;
    int   iColumn;
} NM_GRIDVIEW;
...
typedef struct GRID_CTRL_EXT_CLASS tagGV_DISPINFO {
    NMHDR   hdr;
    GV_ITEM item;
} GV_DISPINFO;

// This is sent to the Grid from child in-place edit controls
typedef struct GRID_CTRL_EXT_CLASS tagGV_CACHEHINT {
    NMHDR      hdr;
    CCellRange range;
} GV_CACHEHINT;
...
void /*AFXAPI*/ GRID_CTRL_EXT_CLASS DDX_GridControl(CDataExchange* pDX, int nIDC, CGridCtrl& rControl);
/////////////////////////////////////////////////////////////////////////////
// CGridCtrl window

class GRID_CTRL_EXT_CLASS CGridCtrl : public CWnd
{
...
// Implementation
private:
	BOOL m_headerfontinited;
	BOOL m_footerfontinited;
public:
	CString m_strFooter;
	CString m_strHeader;
	void SetFooterFont(const LOGFONT & font);
	void SetHeaderFont(const LOGFONT & font);
	void GetFooterFont(LOGFONT& font);
	void GetHeaderFont(LOGFONT& font);
	LOGFONT m_footerfont;
	LOGFONT m_headerfont;
	CString m_stReport;
    virtual ~CGridCtrl();
